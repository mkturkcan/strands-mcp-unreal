...
void UCitySampleCrowdVisualizationFragmentInitializer::Execute(FMassEntityManager& EntityManager, FMassExecutionContext& ExecutionContext)
{
	...
	if (CVarUseMetahumanPresets.GetValueOnGameThread() == true)
	{
		...
		if (UCrowdPresetDataAsset* PresetDataAsset = Cast<UCrowdPresetDataAsset>(PresetDataAssetPath.TryLoad()))
		{
			...
			{
				EntityQuery.ForEachEntityChunk(ExecutionContext, [this, Presets, RepresentationSubsystem](FMassExecutionContext& Context)
                {
                    ...
                    for (FMassExecutionContext::FEntityIterator EntityIt = Context.CreateEntityIterator(); EntityIt; ++EntityIt)
                    {
                        ...
                        VisualizationList[EntityIt].VisualizationID = FCrowdVisualizationID(Presets[PresetIndex].CharacterOptions);
                        ...
                        VisualizationDataList[EntityIt].StaticMeshDescHandle = RepresentationSubsystem->FindOrAddStaticMeshDesc(StaticMeshDec);
                    }
                });
	...
	EntityQuery.ForEachEntityChunk(ExecutionContext, [&, this, RepresentationSubsystem, CachedCrowdScalabilityValues, RandomStream](FMassExecutionContext& Context)
	{
		const TArrayView<FCitySampleCrowdVisualizationFragment> VisualizationList = Context.GetMutableFragmentView<FCitySampleCrowdVisualizationFragment>();
