...
protected:
	 ...
	 * 
	 * @returns	FWidgetAnimationHandle for the played intro animation
	...
	FWidgetAnimationHandle AnimateIn();
	...
	*/
	 ...
	 *			However, if nullptr is returned, the events will fire immediately.
	 * 
	 * @returns	FWidgetAnimationHandle for the played outro animation
	 */
	UFUNCTION(BlueprintImplementableEvent, Category = "CitySamplePanel|Animation")
	FWidgetAnimationHandle AnimateOut();
...
private:
	...
	void OnAnimateIn(FWidgetAnimationState& AnimationState);
	/** Function to be bound to an outro animation finished event, if a sequence was provided by AnimateOut */
	void OnAnimateOut(FWidgetAnimationState& AnimationState);
	...
	UPROPERTY(Transient)
	TMap<FWidgetAnimationHandle, UCitySamplePanel*> AnimateInPanelMapping;
	UPROPERTY(Transient)
	TMap<FWidgetAnimationHandle, UCitySamplePanel*> AnimateOutPanelMapping;
